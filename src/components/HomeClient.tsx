        ...
        <div className="container hero-content">
          <div className="row align-items-center">
            <div className="col-lg-7" data-aos="fade-right">
              <span className="hero-kicker mb-3">{getSiteText('hero.kicker', t("phrase.NPC RWANDA | PARALYMPIC PRIDE"))}</span>
              <h1>
                <span className="visually-hidden">NPC Rwanda - National Paralympic Committee of Rwanda</span>
          ...
          <div className="row align-items-center g-5">
            <div className="col-lg-6" data-aos="fade-up">
              <img
                ...
                alt="National Paralympic Committee of Rwanda - Para-athletics"
